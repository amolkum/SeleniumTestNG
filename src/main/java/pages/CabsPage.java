...
public class CabsPage extends PagesBaseClass {
	...
	@FindBy(xpath = "//span[@class='selectedTime']")
	...
	//span[contains(text(),'PICKUP-TIME')]
	...
	@FindBy(xpath ="//div[@class='csw outstationOneway']/div/div[3]/label/p[1]")
...
//########################################################################################################################	
	...
	public void applyPickupTimeApply() {
		try {
			//Actions actions=new Actions(driver);
			//actions.click(applyBtn).build().perform();
			//((JavascriptExecutor) driver).executeScript("arguments[0].click();", applyBtn);
			applyBtn.click();
			logger.log(Status.PASS, "Pickup time verified got ");
